/* Browse mode: searchable, scrollable list of every word in the set,
   showing translation, article, and example sentences (toggle). */
(function () {
  'use strict';
  ...
  window.Modes.browse = function (ctx) {
    ...
    function buildRow(e) {
      ...
      if (e.examples && e.examples.length && A.settings.get('showExample')) {
        row.appendChild(A.examplesNode(e.examples, 'row__ex'));
      }
      return row;
    }
    ...
    function buildList() {
      ...
      vis.forEach(function (e) { l.appendChild(buildRow(e)); });
